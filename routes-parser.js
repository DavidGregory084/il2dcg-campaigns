...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(entries) { return [...entries]; },
      peg$c1 = function(entry) { return entry; },
      peg$c2 = function(header, waypoints) {
          return { ...header, waypoints };
        },
      peg$c3 = "[",
      peg$c4 = peg$literalExpectation("[", false),
      peg$c5 = " to ",
      peg$c6 = peg$literalExpectation(" to ", false),
      peg$c7 = "]",
      peg$c8 = peg$literalExpectation("]", false),
      peg$c9 = function(from, to) { return { from, to }; },
      peg$c10 = /^[a-zA-Z0-9_]/,
      peg$c11 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false),
      peg$c12 = function(location) { return location.join(""); },
      peg$c13 = function(waypoint) { return waypoint },
      peg$c14 = function(number, numbers) { return [number, ...numbers]; },
      peg$c15 = /^[ ]/,
      peg$c16 = peg$classExpectation([" "], false, false),
      peg$c17 = function(number) { return number; },
      peg$c18 = function(negative, digits, decimals) {
      ...
      peg$c26 = function(digits) { return digits },
      peg$c27 = /^[ \t\n\r]/,
  ...
  function peg$parseWaypoints() {
    var s0, s1, s2;

    s0 = peg$currPos;
    s1 = peg$parseWhitespace();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseWaypoint();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c13(s2);
        s0 = s1;
